---
title: 'Reducción de Olanzapine: síntomas colinérgicos, sueño y seguimiento de recaídas'
slug: olanzapine-reduction-cholinergic-symptoms-sleep-and-relapse-monitoring
description: Respuestas basadas en la evidencia sobre reducción de olanzapine, posibles síntomas de retirada, cronología, formulaciones y cuándo la evaluación clínica es urgente.
primary_keyword: retirada olanzapine
secondary_keywords:
- reducción gradual olanzapine
- retirada Zyprexa
- insomnio después de dejar olanzapine
...
content_hub: Otros medicamentos
priority: P2
...
- Zyprexa
medication_class: antipsicótico de segunda generación
...
app_keyword_theme: retirada olanzapine
suggested_internal_links:
- /es/guides/medication-classes/
- /es/guides/when-how-to-start-tapering/
- /es/guides/talk-to-doctor-about-tapering/
...
locale: es
canonical_url: https://rxdown.app/es/guides/olanzapine-reduction-cholinergic-symptoms-sleep-and-relapse-monitoring/
hreflang:
...
---
# Reducción de Olanzapine: síntomas colinérgicos, sueño y seguimiento de recaídas
...
|---|---|
| Nombre canónico utilizado en este artículo | olanzapine |
| Clase de medicamento | antipsicótico de segunda generación [1] |
| Contexto farmacocinético | La semivida de eliminación es muy variable, suele ser de unas 21 a 54 hours y puede diferir según la edad, el sexo y el tabaquismo. [1] |
| problema de formulación | Existen comprimidos estándar, bucodispersables e inyectables de acción prolongada. Los cambios en inyectables prolongados requieren manejo especializado y no pueden modelarse como reducción de comprimidos orales. [1] |
| Dominios sintomáticos comunicados con frecuencia | Insomnio, náuseas, sudoración, inquietud, ansiedad, síntomas abdominales y síntomas motores [1] |
| principal problema de seguridad | La psicosis, manía, agitación intensa, riesgo suicida, catatonía o incapacidad para atender las necesidades básicas requiere evaluación urgente. [1] |
...
| 3 | Ensayo clínico aleatorizado | A los dos años, la reducción gradual aumentó las recaídas y no mejoró el resultado primario de funcionamiento social en la población estudiada. |
| 4 | Propuesta mecanística y revisión narrativa | Aporta una justificación basada en receptores; la evidencia comparativa sobre resultados clínicos sigue siendo limitada. |
...
Olanzapine tiene efectos anticolinérgicos, antihistamínicos, dopaminérgicos y sobre serotonin. Tras reducirla pueden aparecer insomnio, síntomas autonómicos o gastrointestinales, síntomas motores o recurrencia de psicosis o manía.

**Contexto farmacocinético:** La semivida de eliminación es muy variable, habitualmente de unas 21 to 54 hours, y puede diferir según la edad, el sexo y el tabaquismo. Los promedios farmacocinéticos describen grupos, no una cuenta atrás personal. La edad, la función hepática o renal, el metabolismo genético, los medicamentos con interacciones, la adherencia y la formulación pueden modificar la exposición.

## Posibles síntomas después de una reducción o suspensión

Los informes y la información del producto pueden incluir insomnio, náuseas, sudoración, inquietud, ansiedad, síntomas abdominales y síntomas motores. Estos síntomas por sí solos no son lo bastante específicos para diagnosticar retirada. Las pistas más sólidas son un cambio plausible de medicación, una relación temporal compatible, un patrón de síntomas diferente de la afección original y la evolución con el tiempo.
...
Un cronograma fijo de «día 1 a día 14» puede ser engañoso. La semivida larga y variable puede retrasar los cambios. Dejar de fumar o volver a hacerlo también puede modificar la exposición a olanzapine durante una reducción gradual.
...
Existen comprimidos estándar, bucodispersables e inyectables de acción prolongada. Los cambios en inyectables prolongados requieren manejo especializado y no pueden modelarse como reducción de comprimidos orales.
...
La sudoración, las náuseas, la diarrea, el insomnio y la inquietud pueden reflejar retirada o rebote colinérgico. La psicosis, la manía o un cambio grave del estado de ánimo pueden ser recaída y requieren evaluación rápida.
...
Deben revisarse la indicación psiquiátrica, el tabaquismo, la salud metabólica, las recaídas previas, las observaciones de familiares o apoyos y el producto oral o inyectable exacto.
...
La ficha técnica y la orientación específica de clase respaldan reconocer posibles síntomas tras la reducción y evitar cambios bruscos cuando existe dependencia física clínicamente importante o riesgo de recaída. Los modelos mecanísticos de retirada no anulan los datos clínicos de recaída y ninguna curva de receptores proporciona una pauta universalmente segura.
...
Busque una evaluación médica local urgente si se da cualquiera de las siguientes situaciones. Esta lista es deliberadamente prudente y no es una lista diagnóstica:
        ...
        - psicosis o manía de nueva aparición
- Riesgo inmediato de autolesión o violencia
- Catatonía, confusión grave o incapacidad para mantener la hidratación
...
- ¿Qué indicación trata actualmente olanzapine y cuáles son los riesgos de continuar frente a cambiarlo?
...
### ¿Puede diagnosticarse la retirada de olanzapine solo por los síntomas?
...
### ¿Puedo triturar, partir, abrir o disolver olanzapine?
...
Suggested URL: /es/guides/olanzapine-reduction-cholinergic-symptoms-sleep-and-relapse-monitoring/
...
Suggested internal links: Medication class overview → /es/guides/medication-classes/; How to start a medication reduction → /es/guides/when-how-to-start-tapering/; How to talk with a prescriber → /es/guides/talk-to-doctor-about-tapering/
