---
title: 'Sevrage de l’alprazolam (Xanax) : symptômes entre les prises, risques et questions de réduction progressive'
slug: alprazolam-xanax-withdrawal-interdose-symptoms-risks-and-tapering-questions
description: Réponses fondées sur les preuves concernant la réduction d’alprazolam, les symptômes de sevrage possibles, leur chronologie, les formes pharmaceutiques et les situations nécessitant une évaluation urgente.
primary_keyword: sevrage alprazolam
secondary_keywords:
- sevrage Xanax
- réduction progressive alprazolam
- sevrage entre prises Xanax
...
- Xanax
medication_class: benzodiazépine
...
app_keyword_theme: sevrage alprazolam
suggested_internal_links:
- /fr/guides/ashton-manual-benzodiazepine-tapering/
...
locale: fr
canonical_url: https://rxdown.app/fr/guides/alprazolam-xanax-withdrawal-interdose-symptoms-risks-and-tapering-questions/
hreflang:
...
|---|---|
| Nom de référence utilisé dans cet article | alprazolam |
| Classe médicamenteuse | benzodiazépine [1] |
| Contexte pharmacocinétique | La demi-vie moyenne d’élimination est d’environ 11 heures, avec une variabilité importante. [1] |
| problème de formulation | Des comprimés à libération immédiate, des comprimés à libération prolongée et une solution buvable concentrée peuvent être disponibles. Les comprimés à libération prolongée ne doivent généralement pas être écrasés ou mâchés, et les formulations ne sont pas interchangeables sans consigne du professionnel prescripteur. [1] |
| Domaines symptomatiques fréquemment rapportés | Anxiété, insomnie, tremblements, transpiration, hypersensibilité sensorielle, modifications de la perception et nausées [1] |
| principal enjeu de sécurité | Les convulsions, le délirium, l’agitation sévère, les hallucinations ou l’instabilité des paramètres vitaux peuvent engager le pronostic vital. [1] |
...
Suggested URL: /fr/guides/alprazolam-xanax-withdrawal-interdose-symptoms-risks-and-tapering-questions/
...
Suggested internal links: Benzodiazepine tapering and the Ashton approach → /fr/guides/ashton-manual-benzodiazepine-tapering/; Withdrawal vs relapse → /fr/guides/antidepressant-withdrawal-vs-relapse/; How to talk with a prescriber → /fr/guides/talk-to-doctor-about-tapering/
