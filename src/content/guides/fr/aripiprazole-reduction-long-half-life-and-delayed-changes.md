---
title: 'Réduction de aripiprazole : longue demi-vie et changements retardés'
slug: aripiprazole-reduction-long-half-life-and-delayed-changes
description: Réponses fondées sur les preuves concernant la réduction d’aripiprazole, les symptômes de sevrage possibles, leur chronologie, les formes pharmaceutiques et les situations nécessitant une évaluation urgente.
primary_keyword: sevrage aripiprazole
secondary_keywords:
- sevrage Abilify
- réduction progressive aripiprazole
- réduction de aripiprazole
...
canonical_medication_name: aripiprazole
brand_name_search_synonyms:
- Abilify
medication_class: antipsychotique de deuxième génération et agoniste partiel de dopamine
...
app_keyword_theme: sevrage aripiprazole
...
medication_class_en: second-generation antipsychotic and dopamine partial agonist
locale: fr
canonical_url: https://rxdown.app/fr/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
hreflang:
  en: https://rxdown.app/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  x-default: https://rxdown.app/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  zh-Hant: https://rxdown.app/zh/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  ja: https://rxdown.app/ja/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  ko: https://rxdown.app/ko/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  de: https://rxdown.app/de/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  es: https://rxdown.app/es/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  fr: https://rxdown.app/fr/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  id: https://rxdown.app/id/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
  pt-PT: https://rxdown.app/pt/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
translation_source_sha256: d8cc3dba4bfbe9ae2d10d944475118fd749c499f5c929c5c5a453a3a55dcc047
...
---
# Réduction de aripiprazole : longue demi-vie et changements retardés
...
|---|---|
| Nom de référence utilisé dans cet article | aripiprazole |
| Classe médicamenteuse | antipsychotique de deuxième génération et agoniste partiel de dopamine [1] |
| Contexte pharmacocinétique | La demi-vie moyenne est d’environ 75 heures pour aripiprazole et d’environ 94 heures pour son métabolite actif ; l’exposition peut être beaucoup plus longue chez les métaboliseurs lents de CYP2D6. [1] |
| problème de formulation | Il existe des comprimés, des comprimés orodispersibles, une solution buvable et plusieurs produits injectables à action prolongée. Les injectables nécessitent une planification spécialisée et propre au produit. [1] |
| Domaines symptomatiques fréquemment rapportés | Insomnie, anxiété, agitation ou akathisie, nausées, changement d’humeur, symptômes moteurs et irritabilité [1] |
| principal enjeu de sécurité | L’apparition d’une psychose, d’une manie, d’une akathisie sévère empêchant de rester en sécurité, d’une suicidalité ou d’une catatonie exige une évaluation urgente. [1] |
...
aripiprazole et son métabolite actif persistent longtemps dans l’organisme. Après une modification de dose, plusieurs semaines peuvent être nécessaires pour atteindre une nouvelle exposition stable ; quelques premiers jours apparemment calmes ne prouvent donc pas que l’effet final est connu.

**Contexte pharmacocinétique :** La demi-vie moyenne est d’environ 75 hours pour aripiprazole et d’environ 94 hours pour son métabolite actif ; l’exposition peut être beaucoup plus longue chez les métaboliseurs lents CYP2D6. Les moyennes pharmacocinétiques décrivent des groupes, pas un compte à rebours personnel. L’âge, la fonction hépatique ou rénale, le métabolisme génétique, les médicaments en interaction, l’observance et la formulation peuvent modifier l’exposition.

## Symptômes possibles après une réduction ou un arrêt

Les signalements et les informations produit peuvent mentionner insomnie, anxiété, agitation ou akathisie, nausées, changement d’humeur, symptômes moteurs et irritabilité. Ces symptômes ne sont pas suffisamment spécifiques pour diagnostiquer à eux seuls un sevrage. Les indices les plus solides sont une modification médicamenteuse plausible, une relation temporelle compatible, un schéma symptomatique différent de l’affection initiale et l’évolution dans le temps.
...
Une chronologie fixe allant du « jour 1 au jour 14 » peut être trompeuse. Les changements peuvent être retardés et s’accumuler progressivement. Les interactions avec des inhibiteurs ou des inducteurs du CYP2D6 ou du CYP3A4 peuvent modifier l’exposition.
...
Il existe des comprimés, des comprimés orodispersibles, une solution buvable et plusieurs produits injectables à action prolongée. Les injectables nécessitent une planification spécialisée et propre au produit.
...
L’agitation peut correspondre à une akathisie, une anxiété, une activation ou un sevrage. Une psychose, une manie, une dépression sévère ou des troubles nouveaux du contrôle des impulsions nécessitent une évaluation plus large.
...
Il faut définir l’indication psychiatrique, les interactions métaboliques, la formulation orale ou injectable, le schéma antérieur de rechute et une période d’observation suffisamment longue.
...
- Agitation intérieure sévère avec risque immédiat d’automutilation
- Catatonie ou confusion sévère
...
- Quelle indication l’aripiprazole traite-t-il actuellement, et quels sont les risques de le poursuivre ou de le modifier ?
...
### Peut-on diagnostiquer un sevrage de aripiprazole à partir des seuls symptômes ?
...
### Puis-je écraser, fractionner, ouvrir ou dissoudre aripiprazole ?
...
1. [US prescribing information and DailyMed product records for aripiprazole.](https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=aripiprazole) **Evidence type:** Regulator-hosted product labeling. **Use in this draft:** Verify the exact manufacturer, formulation, strength, and country before publication or any formulation advice.
...
Suggested URL: /fr/guides/aripiprazole-reduction-long-half-life-and-delayed-changes/
Canonical entity: aripiprazole
