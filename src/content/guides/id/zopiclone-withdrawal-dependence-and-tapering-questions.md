---
title: 'Putus obat Zopiclone: ketergantungan dan pertanyaan penurunan'
slug: zopiclone-withdrawal-dependence-and-tapering-questions
description: Jawaban berbasis bukti tentang pengurangan dosis zopiclone, kemungkinan gejala putus obat, waktu, masalah sediaan, dan kapan penilaian klinis mendesak.
primary_keyword: putus zopiclone
secondary_keywords:
- pengurangan dosis zopiclone
- ketergantungan zopiclone
- insomnia rebound akibat zopiclone
...
canonical_medication_name: zopiclone
...
app_keyword_theme: putus zopiclone
...
region_note: zopiclone dipasarkan di banyak negara tetapi tidak disetujui di Amerika Serikat; halaman lokal harus hanya menggunakan label dan nama merek setempat.
source_locale: en
required_reviewers_en: prescriber and pharmacist with medication-class expertise
region_note_en: Zopiclone is marketed in many countries but is not approved in the United States; use local labeling and brand names only in localized pages.
medication_class_en: Z-drug hypnotic and benzodiazepine-receptor agonist
locale: id
canonical_url: https://rxdown.app/id/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
hreflang:
  en: https://rxdown.app/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  x-default: https://rxdown.app/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  zh-Hant: https://rxdown.app/zh/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  ja: https://rxdown.app/ja/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  ko: https://rxdown.app/ko/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  de: https://rxdown.app/de/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  es: https://rxdown.app/es/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  fr: https://rxdown.app/fr/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  id: https://rxdown.app/id/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
  pt-PT: https://rxdown.app/pt/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
translation_source_sha256: da78f7d2bd52ae6141ac26bb4100bd1a898c7bf120174ed17a7b89071ca1aef1
...
---
# Putus obat Zopiclone: ketergantungan dan pertanyaan penurunan
...
|---|---|
| Nama baku yang digunakan dalam artikel ini | zopiclone |
| Kelas obat | Hipnotik Z-drug dan agonis reseptor benzodiazepin [1] |
| Konteks farmakokinetik | Waktu paruh eliminasi umumnya sekitar 5 hours, dengan paparan lebih lama pada lansia dan gangguan hati. [1] |
| masalah formulasi | Kekuatan dan garis belah tablet berbeda menurut negara. Zopiclone tidak disetujui di Amerika Serikat, dan petunjuk produk regional harus digunakan. [1] |
...
| masalah keselamatan utama | Kejang, delirium, perilaku tidur berbahaya, kebingungan berat, atau gangguan napas memerlukan penilaian segera. [1] |
...
Zopiclone adalah senyawa induk rasemik yang terkait dengan eszopiclone dan digunakan luas di luar Amerika Serikat. Peringatan ketergantungan dan putus obat berlaku, tetapi label dan kekuatan yang tersedia berbeda menurut wilayah.

**Konteks farmakokinetik:** Waktu paruh eliminasi umumnya sekitar 5 jam, dengan paparan lebih lama pada lansia dan gangguan hati. Rata-rata farmakokinetik menggambarkan kelompok, bukan hitung mundur pribadi. Usia, fungsi hati atau ginjal, metabolisme genetik, obat yang berinteraksi, kepatuhan, dan formulasi dapat mengubah paparan.
...
Garis waktu tetap “hari 1 hingga hari 14” dapat menyesatkan. Insomnia rebound dan gejala lain dapat segera muncul setelah pengurangan mendadak karena paparan turun relatif cepat.
...
Kekuatan dan garis belah tablet berbeda menurut negara. Zopiclone tidak disetujui di Amerika Serikat, dan petunjuk produk regional harus digunakan.
...
Peningkatan insomnia pada malam pertama dapat merupakan rebound; kesulitan tidur menetap memerlukan penilaian insomnia kronis dan penyebab tidur atau medis lain.
...
Rencana harus menggunakan label produk setempat dan mencakup CBT-I, peninjauan alkohol serta sedatif lain, dan risiko jatuh atau pernapasan.
...
Label produk dan panduan khusus kelas mendukung pengenalan gejala yang mungkin terjadi setelah pengurangan dan menghindari perubahan mendadak bila ada ketergantungan fisik atau risiko kekambuhan yang bermakna secara klinis. Label dan studi regional berbeda; tidak ada satu jadwal manipulasi tablet atau penurunan yang berlaku internasional.
...
- Napas lambat atau sulit, atau tidak responsif
...
- Indikasi apa yang sedang diobati dengan zopiclone, dan apa risiko melanjutkan dibanding mengubahnya?
...
### Dapatkah putus obat zopiclone didiagnosis hanya dari gejala?
...
### Bolehkah saya menghancurkan, membelah, membuka, atau melarutkan zopiclone?
...
Zopiclone dipasarkan di banyak negara tetapi tidak disetujui di United States; gunakan label dan nama merek lokal hanya pada halaman setempat. Verifikasi label produk, produsen, kekuatan, sistem pelepasan, dan jalur klinis lokal sebelum publikasi atau penggunaan. Petunjuk yang benar untuk satu tablet atau kapsul dapat salah untuk produk lain.

## Khusus produk dan dikonfirmasi apoteker

1. [US prescribing information and DailyMed product records for zopiclone.](https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=zopiclone) **Evidence type:** Regulator-hosted product labeling. **Use in this draft:** Verify the exact manufacturer, formulation, strength, and country before publication or any formulation advice.
...
Suggested URL: /id/guides/zopiclone-withdrawal-dependence-and-tapering-questions/
Canonical entity: zopiclone
